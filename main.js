...
var sketch;
function preload() {
    var classifier = ml5.imageClassifier("DoodleNet", modelLoaded);
}
...
function setup() {
    ...
    canvas.center();
    canvas.mouseRealeased(classifier.classify(canvas,gotResult));
}
...
function updateCanvas() {
    ...
    document.getElementById("sketch_to_draw").innerHTML = sketch;
