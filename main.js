...
var r_num = Math.floor((Math.random() * quick_draw_data_set.length) + 1);
console.log(quick_draw_data_set[r_num]);
var sketch = quick_draw_data_set[r_num];
...
function updateCanvas() {
    r_num = Math.floor((Math.random() * quick_draw_data_set.length) + 1);
    sketch = quick_draw_data_set[r_num];
    document.getElementById("sketch_to_draw").innerHTML = "Sketch to be drawn is "+sketch;
    background("white");
    console.log(sketch)
}
